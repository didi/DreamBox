...
-(void)setDataWithModel:(DBListModel *)listModel andPathId:(NSString *)pathId {
    [super setDataWithModel:listModel andPathId:pathId];
    ...
    if(listModel.src){
        [self handleChangeOn:listModel.changeOn];
    }
    
    if (listModel.vh) {
        self.vh = listModel.vh ;
    }
