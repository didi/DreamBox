...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        [self.allModelClassTypesArray setValue:NSClassFromString(@"DBButtonModel") forKey:@"button"];
        ...
        [self.allViewClassTypesArray setValue:NSClassFromString(@"DBButton") forKey:@"button"];
