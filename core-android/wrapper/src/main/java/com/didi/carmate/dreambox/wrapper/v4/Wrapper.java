...
import com.didi.carmate.dreambox.wrapper.v4.inner.WrapperInner;
import com.didi.carmate.dreambox.wrapper.v4.inner.WrapperUtils;
...
public class Wrapper {
    ...
    private static WrapperImpl getDefaultImpl() {
        try {
            Class cls = Class.forName("com.didi.carmate.dreambox.wrapper.v4.impl.SimpleWrapper");
