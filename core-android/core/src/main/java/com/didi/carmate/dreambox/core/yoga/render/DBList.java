...
import com.didi.carmate.dreambox.core.yoga.render.view.list.DBListAdapter;
import com.didi.carmate.dreambox.core.yoga.render.view.list.DBListInnerAdapter;
import com.didi.carmate.dreambox.core.yoga.render.view.list.DBListItemRoot;
import com.didi.carmate.dreambox.core.yoga.render.view.list.DBListView;
import com.didi.carmate.dreambox.core.yoga.render.view.list.IAdapterCallback;
import com.didi.carmate.dreambox.core.yoga.render.view.list.IRefreshListener;
import com.didi.carmate.dreambox.core.yoga.render.view.list.OnLoadMoreListener;
...
//                    }
    ...
    protected void onChildrenBind(Map<String, String> attrs, List<DBContainer<?>> children) {
        ...
        DBContainer<DBYogaView> listHeader = null;
        DBContainer<DBListItemRoot> listVh = null;
        DBContainer<DBYogaView> listFooter = null;
    ...
    private static final class ListAdapterCallback extends AdapterCallback {
        private final DBContainer<DBYogaView> mDBListHeader;
        private final DBContainer<DBListItemRoot> mDBListVh;
        private final DBContainer<DBYogaView> mDBListFooter;

        private ListAdapterCallback(
                DBContainer<DBYogaView> listHeader,
                DBContainer<DBListItemRoot> listVh,
                DBContainer<DBYogaView> listFooter) {
