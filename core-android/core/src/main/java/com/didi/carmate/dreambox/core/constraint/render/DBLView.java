...
import com.didi.carmate.dreambox.core.constraint.render.view.DBCoreViewH;
import com.didi.carmate.dreambox.core.constraint.render.view.DBCoreViewV;
import com.didi.carmate.dreambox.core.constraint.render.view.DBConstraintView;
import com.didi.carmate.dreambox.core.constraint.render.view.DreamBoxCoreView;
...
public class DBLView extends DBNode {
    ...
    private DBConstraintView mDBRootView;
    ...
    private void generateRootView() {
        if (!DBUtils.isEmpty(scroll)) {
            if (null == mDBCoreView) {
                mDBRootView = new DBConstraintView(mDBContext);
