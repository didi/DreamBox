...
import com.didi.carmate.dreambox.core.constraint.render.view.list.AdapterCallback;
import com.didi.carmate.dreambox.core.constraint.render.view.list.DBListAdapter;
import com.didi.carmate.dreambox.core.constraint.render.view.list.DBListInnerAdapter;
import com.didi.carmate.dreambox.core.constraint.render.view.list.DBListItemRoot;
import com.didi.carmate.dreambox.core.constraint.render.view.list.DBListView;
import com.didi.carmate.dreambox.core.constraint.render.view.list.IAdapterCallback;
import com.didi.carmate.dreambox.core.constraint.render.view.list.IRefreshListener;
import com.didi.carmate.dreambox.core.constraint.render.view.list.OnLoadMoreListener;
...
//                    }
    ...
    protected void onChildrenBind(Map<String, String> attrs, List<DBContainer<?>> children) {
        ...
        DBContainer<DBConstraintView> listHeader = null;
        DBContainer<DBListItemRoot> listVh = null;
        DBContainer<DBConstraintView> listFooter = null;
    ...
    private static final class ListAdapterCallback extends AdapterCallback {
        private final DBContainer<DBConstraintView> mDBListHeader;
        private final DBContainer<DBListItemRoot> mDBListVh;
        private final DBContainer<DBConstraintView> mDBListFooter;

        private ListAdapterCallback(
                DBContainer<DBConstraintView> listHeader,
                DBContainer<DBListItemRoot> listVh,
                DBContainer<DBConstraintView> listFooter) {
