...
public class DBCoreViewV extends ScrollView implements IDBCoreView {
    ...
    private DBConstraintView mRootView;

    public DBCoreViewV(DBContext dbContext, DBConstraintView dbRootView) {
        super(dbContext.getContext());
        mDBContext = dbContext;
        mRootView = dbRootView;
        init(dbRootView);
    }
    ...
    private void init(DBConstraintView rootView) {
