 ...
 * date: 2020/5/22
 */
public class DBConstraintView extends ConstraintLayout {
    private final DBContext mDBContext;

    public DBConstraintView(DBContext dbContext) {
        super(dbContext.getContext(), null);
        mDBContext = dbContext;
    }

    public DBConstraintView(DBContext dbContext, AttributeSet attrs) {
        super(dbContext.getContext(), attrs);
        mDBContext = dbContext;
    }

    public DBConstraintView(DBContext dbContext, AttributeSet attrs, int defStyleAttr) {
