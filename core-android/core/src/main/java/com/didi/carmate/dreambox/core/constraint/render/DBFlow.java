...
import com.didi.carmate.dreambox.core.constraint.render.view.flow.DBFlowAdapter;
import com.didi.carmate.dreambox.core.constraint.render.view.flow.DBFlowLayout;
...
public class DBFlow extends DBBaseView<DBFlowLayout> {
    ...
    protected void onChildrenBind(Map<String, String> attrs, List<DBContainer<?>> children) {
        ...
        DBContainer<DBConstraintView> cell = null;
    ...
    private static final class FlowAdapterCallback extends AdapterCallback {
        ...
        private final DBContainer<DBConstraintView> mFlowCell;

        private FlowAdapterCallback(DBContext dbContext, DBContainer<DBConstraintView> flowCell) {
            mDBContext = dbContext;
            mFlowCell = flowCell;
        }

        @Override
        public void onBindItemView(DBConstraintView itemRoot, JsonObject data) {
            if (null == mFlowCell) {
