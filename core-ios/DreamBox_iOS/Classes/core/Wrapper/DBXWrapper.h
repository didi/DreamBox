...
@class DBXWrapperConfigModel;
NS_ASSUME_NONNULL_BEGIN
@protocol DBXWrapperProtocl <NSObject>
...
@interface DBXWrapper : NSObject <DBXWrapperProtocl>
...
@property (nonatomic, strong) DBXWrapperConfigModel *config;
