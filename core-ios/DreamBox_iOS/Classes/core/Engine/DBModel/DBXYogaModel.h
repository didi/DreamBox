...
@interface DBXYogaModel : NSObject
...
@property (nonatomic, copy) NSString *positionType;         //布局解析类型（绝对/相对）
...
@property (nonatomic, copy) NSString *positionLeft;         //相对偏移/绝对位置
@property (nonatomic, copy) NSString *positionTop;
@property (nonatomic, copy) NSString *positionRight;
@property (nonatomic, copy) NSString *positionBottom;
