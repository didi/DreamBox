...
- (void)wrapperTest {
    NSString *mockDataString = [NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"yoga_flow" ofType:@"json"] encoding:NSUTF8StringEncoding error:nil];
